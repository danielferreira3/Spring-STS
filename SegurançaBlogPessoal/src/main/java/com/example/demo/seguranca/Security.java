...
//SEPARA AS FUNÇÕES DOS PREVELIGIADOS
	@Override
	protected void configure(HttpSecurity http) throws Exception {
		...
		//autentica a senha com criptografia e discriptografa a senha do usuario
	@Override
	protected void configure(AuthenticationManagerBuilder auth) throws Exception { // autentica usuario e senha
		auth.userDetailsService(userDetailsService).passwordEncoder(new BCryptPasswordEncoder()); //converte oque o user digitar em cripto
	}
